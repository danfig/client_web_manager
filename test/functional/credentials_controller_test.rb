...
class CredentialsControllerTest < ActionController::TestCase
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post :create, credential: { notes: @credential.notes, password: @credential.password, type: @credential.type, url: @credential.url }
    end
  ...
  test "should update credential" do
    put :update, id: @credential, credential: { notes: @credential.notes, password: @credential.password, type: @credential.type, url: @credential.url }
    assert_redirected_to credential_path(assigns(:credential))
  end
